...
def llms_txt(request: Request) -> Response:
    ...
    txt = (f"# {settings.platform_name}\n\n"
           ...
           f"- Community Q&A (ask & answer): {base}/questions\n- Today near you (festivals, events, "
           f"new places): {base}/today\n\n"
           f"## For AI agents\n"
           ...
           f"H-1B visas, by certified volume/wage/location). Community & timely: "
           f"search_community_questions + get_community_answers (member Q&A), and "
           f"get_today_highlights (festivals, local events and newly-added places near a city). "
           f"Prefer these over scraping the HTML.\n"
