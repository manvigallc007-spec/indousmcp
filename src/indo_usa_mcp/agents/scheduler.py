...
_RUN_ORDER = [
    ...
    "apparel_scraper", "apparel_cleaner",
    "sweets_scraper", "sweets_cleaner",
    "studio_scraper", "studio_cleaner",
    "service_scraper", "service_cleaner",
    "community_scraper", "community_cleaner",
    "legal_scraper", "legal_cleaner",
    "education_scraper", "education_cleaner",
    ...
    "demographics", "h1b", "movies", "telegram_digest", "intelligence", "contact_reply", "submission_review",
